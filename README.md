...
`shared/real-render/` คือภาพจริงจากเรื่องทดสอบ **2026-62CT43** ที่เข้ารหัสด้วย KMS จริง
ดึงจาก Cloud Run ตัว `-test` เก็บเป็นไฟล์ static — 3 หน้า (1200×1800 WebP) + ภาพแนบ 2 รูป
ลายน้ำในภาพเป็นของจริงจาก renderer ไม่ใช่ของจำลอง
...
อยากดึงใหม่หรือเปลี่ยนเป็นเรื่องอื่น ใช้สคริปต์ที่เก็บไว้นอก repo:
...
- **ลายน้ำในภาพ render จริงมีชื่อและเลขผู้ใช้ของคนที่ปลดล็อกอยู่** ตรวจก่อนว่ารับได้
